...
namespace Scripts.UI.EditorUI.Components
{
    public class EditableConfigurationList : UIElementBase
    {
        ...
        public void Set(string title, IEnumerable<PrefabConfiguration> items, UnityAction<IEnumerable<PrefabConfiguration>> onListChanged)
        {
            ...
            _list.ForEach(item =>
            {
                DeletableConfigurationListButton newButton = ObjectPool.Instance.Get(itemPrefab.gameObject, _content.gameObject)
            ...
            Button addButton = ObjectPool.Instance.Get(buttonPrefab.gameObject, _content.gameObject)
                .GetComponent<Button>();
