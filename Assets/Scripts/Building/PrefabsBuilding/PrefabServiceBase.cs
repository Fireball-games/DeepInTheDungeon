...
namespace Scripts.Building.PrefabsBuilding
{
    ...
    {
        /// <summary>
        /// Defines if given type of prefab has any sense in Play mode and optimizes for it if not.
        /// For example such as EntryPoint.
        /// </summary>
        ...
        {
            if (IsEditorOnly || configuration is not TC prefabConfiguration || prefabScript is not TPrefab script) return;
